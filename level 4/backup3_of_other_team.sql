...
prompt Created by ADMIN on יום ראשון 16 יוני 2024
set feedback off
set define off
...
prompt Creating SOLDIERR...
create table SOLDIERR
(
...
alter table OWNS
  add foreign key (SOLDIERR_ID)
  references SOLDIERR (SOLDIERR_ID);
...
prompt Disabling triggers for SOLDIERR...
alter table SOLDIERR disable all triggers;
...
alter table ITEM disable constraint SYS_C009853;
prompt Disabling foreign key constraints for OWNS...
alter table OWNS disable constraint SYS_C009886;
alter table OWNS disable constraint SYS_C009887;
prompt Disabling foreign key constraints for STOREMAN...
alter table STOREMAN disable constraint SYS_C009864;
alter table STOREMAN disable constraint SYS_C009865;
prompt Disabling foreign key constraints for SUPPLIES...
alter table SUPPLIES disable constraint SYS_C009891;
alter table SUPPLIES disable constraint SYS_C009892;
prompt Disabling foreign key constraints for UNIFORM...
alter table UNIFORM disable constraint SYS_C009882;
prompt Disabling foreign key constraints for WEAPON...
alter table WEAPON disable constraint SYS_C009875;
...
delete from OWNS;
commit;
prompt Deleting SOLDIERR...
delete from SOLDIERR;
commit;
...
prompt Loading SOLDIERR...
insert into SOLDIERR (soldier_id, birth_date, soldier_rank, first_name, last_name, unit)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Nike', 'pbutteg@cloudflare.com', 'SaiÃ¢â‚¬â„¢erlong Xiang', 859667);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Costco', 'qyusupovz@nasa.gov', 'TlumaÃ„Âov', 240924);
insert into SUPPLIER (company_name, email, location, company_id)
values ('AmericanExpress', 'fdrewe10@cisco.com', 'Kladanj', 351987);
insert into SUPPLIER (company_name, email, location, company_id)
values ('AbbottLaboratories', 'wcomport11@gnu.org', 'SarÃ„Âqib', 712015);
insert into SUPPLIER (company_name, email, location, company_id)
values ('T-Mobile', 'fdrinkeld12@typepad.com', 'CholargÃƒÂ³s', 494195);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Starbucks', 'rbursell13@vimeo.com', 'Krasnystaw', 154318);
insert into SUPPLIER (company_name, email, location, company_id)
values ('IBM', 'lmorley14@fotki.com', 'Ã…ÂÃ„â„¢czyce', 491794);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Qualcomm', 'aabbate18@flickr.com', 'VÃƒÂ¤rmdÃƒÂ¶', 290983);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Boeing', 'ahandrok1c@xinhuanet.com', 'Ã…Â¢ubarjal', 466659);
insert into SUPPLIER (company_name, email, location, company_id)
values ('GeneralElectric', 'cpieterick1d@theglobeandmail.com', 'Zbiroh', 880502);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Dow', 'dlongstaffe1e@netlog.com', 'Arras', 464893);
insert into SUPPLIER (company_name, email, location, company_id)
values ('MondelezInternational', 'pgarrettson1f@woothemes.com', 'Kostrzyn nad OdrÃ„â€¦', 154459);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('NextEraEnergy', 'rdawid20@constantcontact.com', 'Ã…Å’miya', 780947);
insert into SUPPLIER (company_name, email, location, company_id)
values ('AmericanAirlines', 'gtestro21@ehow.com', 'Waterloo', 370213);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Honeywell', 'myegorkin22@jigsy.com', 'Digdig', 949816);
insert into SUPPLIER (company_name, email, location, company_id)
values ('McDonald', 'koffield23@bigcartel.com', 'PerdÃƒÂµes', 969562);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Citigroup', 'bivamy24@imageshack.us', 'Bielsk Podlaski', 362524);
insert into SUPPLIER (company_name, email, location, company_id)
values ('CardinalHealth', 'akloss25@abc.net.au', 'HamhÃ…Â­ng', 756451);
insert into SUPPLIER (company_name, email, location, company_id)
values ('TheTravelersCompanies', 'hmcnab26@europa.eu', 'Clonskeagh', 758458);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Cigna', 'kmatthiesen27@jiathis.com', 'Balpyk BÃ„Â«', 937171);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('LibertyMutual', 'rbordman2b@berkeley.edu', 'ViÃ…Â¡Ã…Ë†ova', 387901);
insert into SUPPLIER (company_name, email, location, company_id)
values ('DeltaAirLines', 'ipowter2c@sina.com.cn', 'PieniÃ„â„¢Ã…Â¼no', 914553);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Halliburton', 'jbedbrough2l@blinklist.com', 'Grande RiviÃƒÂ¨re Noire', 737743);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Amazon', 'ahawkings2p@rambler.ru', 'PinhÃƒÂ£o', 444896);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('ProcterGamble', 'gdosedale2x@patch.com', 'GuangÃ¢â‚¬â„¢an', 730512);
insert into SUPPLIER (company_name, email, location, company_id)
values ('NVIDIA', 'gduff2y@slate.com', 'SÃƒÂ£o Paulo', 536781);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Visa', 'jwallwork2z@craigslist.org', 'Saint Joseph', 653673);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Mastercard', 'reaslea30@state.gov', 'KurÃƒÂ³w', 803435);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('PayPal', 'pclark34@telegraph.co.uk', 'CubarÃƒÂ¡', 712051);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Comcast', 'oitskovitz38@oracle.com', 'SÃƒÂ£o JoÃƒÂ£o del Rei', 765402);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('AbbottLaboratories', 'slemmertz3o@cpanel.net', 'MarÃ„Âdah', 146872);
insert into SUPPLIER (company_name, email, location, company_id)
values ('T-Mobile', 'ijudd3p@themeforest.net', 'Alaghsas', 878515);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Starbucks', 'emallord3q@columbia.edu', 'Pittsburgh', 429568);
insert into SUPPLIER (company_name, email, location, company_id)
values ('IBM', 'ctimbs3r@gravatar.com', 'BÃ¡ÂºÂ±ng LÃ…Â©ng', 978762);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Amgen', 'dollie47@apple.com', 'AlingsÃƒÂ¥s', 728100);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Colgate-Palmolive', 'fcluney4g@kickstarter.com', 'BÃ…â„¢eclav', 389363);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('KraftHeinz', 'njirzik4l@pagesperso-orange.fr', 'LibofshÃƒÂ«', 196742);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('CardinalHealth', 'cdossantos4s@msu.edu', 'NÃƒÂ©a PÃƒÂ©lla', 866245);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Aflac', 'ctudgay4w@unesco.org', 'MauÃƒÂ©s', 303019);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Broadcom', 'cgregol53@google.nl', 'ZaÃ…Â¡ovÃƒÂ¡', 214746);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('BerkshireHathaway', 'gdoerffer5g@gravatar.com', 'ParanavaÃƒÂ­', 728989);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('ProcterGamble', 'dfoottit5k@nps.gov', 'KrÃƒÂ¡snÃƒÂ¡ LÃƒÂ­pa', 975640);
commit;
prompt 200 records committed...
insert into SUPPLIER (company_name, email, location, company_id)
values ('NVIDIA', 'twhitebread5l@oaic.gov.au', 'KokkinÃƒÂ³choma', 713511);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('PayPal', 'nrohlfs5r@fotki.com', 'Ã…Â½rnovnica', 778697);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Intel', 'jransbury5s@mayoclinic.com', 'Gebre Guracha', 790484);
insert into SUPPLIER (company_name, email, location, company_id)
values ('HomeDepot', 'bmanuely5t@nasa.gov', 'Quimper', 518316);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Verizon', 'rricardot5u@aboutads.info', 'OmÃ„Â«dcheh', 107803);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Coca-Cola', 'sbean61@marriott.com', 'MalanÃƒÂ³w', 134885);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Oracle', 'abennoe62@tripod.com', 'Dayr MawÃ„Âs', 844889);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('ExxonMobil', 'sorto67@disqus.com', 'BÃƒÂ¹ Ã„ÂÃ¡Â»â€˜p', 988842);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('AbbottLaboratories', 'xbidder6b@theguardian.com', 'RÃ„Âbigh', 985015);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('3M', 'sbeedom6j@flickr.com', 'CÃƒÂ¢ndido Mota', 883539);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('MondelezInternational', 'gmacewan6p@mozilla.org', 'VasilikÃƒÂ³n', 595915);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Pfizer', 'dfuente6w@aboutads.info', 'VelkÃƒÂ¡ BystÃ…â„¢ice', 625400);
insert into SUPPLIER (company_name, email, location, company_id)
values ('UPS', 'mdodimead6x@cloudflare.com', 'Xiatang', 629210);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Intuit', 'cpreshaw6y@ucla.edu', 'DomanÃƒÂ­n', 801194);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('RaytheonTechnologies', 'bmerwe77@issuu.com', 'CiÃƒÂ©naga de Oro', 879931);
insert into SUPPLIER (company_name, email, location, company_id)
values ('KraftHeinz', 'tlabadini78@jugem.jp', 'JÃƒÂ¶nkÃƒÂ¶ping', 573003);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Exelon', 'wbowhey79@usgs.gov', 'KÃ„â€¦ty WrocÃ…â€šawskie', 143082);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('LibertyMutual', 'fgulley7l@canalblog.com', 'Ãƒâ€žngelholm', 153254);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Broadcom', 'apople7q@dell.com', 'BeÃ…â€šsznica', 723943);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Amazon', 'ktreend7z@quantcast.com', 'Al Ã¡Â¸Â¨umaydÃ„Ât', 737457);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('NVIDIA', 'sduiged88@walmart.com', 'HafnarfjÃƒÂ¶rÃƒÂ°ur', 810711);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Netflix', 'thatfull8k@home.pl', 'Paris La DÃƒÂ©fense', 354355);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('AbbVie', 'lforsdyke8q@dell.com', 'SantarÃƒÂ©m', 362220);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Costco', 'drown8w@csmonitor.com', 'SpÃƒÂ¡rti', 652389);
insert into SUPPLIER (company_name, email, location, company_id)
values ('AmericanExpress', 'belphinston8x@huffingtonpost.com', 'Silago', 133266);
insert into SUPPLIER (company_name, email, location, company_id)
values ('AbbottLaboratories', 'wreddel8y@eventbrite.com', 'Praia das MaÃƒÂ§ÃƒÂ£s', 957508);
insert into SUPPLIER (company_name, email, location, company_id)
values ('T-Mobile', 'ghasselby8z@ameblo.jp', 'Yungaisi', 245601);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Starbucks', 'mcapnor90@squidoo.com', 'Zopilotepe', 947405);
insert into SUPPLIER (company_name, email, location, company_id)
values ('IBM', 'mgoadsby91@bizjournals.com', 'CotÃƒÂ©-Lai', 934288);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Dow', 'dferrolli9b@netscape.com', 'NÃƒÂ¡chod', 528287);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('DeltaAirLines', 'edurtnala9@ustream.tv', 'SÃƒÂ£o Francisco do Sul', 671990);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('FluorCorpora', 'leverilaj@time.com', 'MendÃ„Â«', 968359);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Apple', 'jleverentzak@ovh.net', 'Hovtashen', 169308);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Microsoft', 'vvantal@twitter.com', 'Ã¢â‚¬ËœIzbat al Burj', 160748);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Amazon', 'rcromleyam@arizona.edu', 'Gnojnica', 195334);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Google', 'hearsmanan@edublogs.org', 'DobÃ…Â¡ice', 251729);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Facebook', 'mlortzingao@icio.us', 'Silae', 952724);
insert into SUPPLIER (company_name, email, location, company_id)
values ('Tesla', 'cstonebanksap@bizjournals.com', 'HavlÃƒÂ­Ã„ÂkÃ…Â¯v Brod', 879526);
insert into SUPPLIER (company_name, email, location, company_id)
values ('BerkshireHathaway', 'deveralaq@weather.com', 'KobeÃ…â„¢ice', 595057);
insert into SUPPLIER (company_name, email, location, company_id)
...
insert into SUPPLIER (company_name, email, location, company_id)
values ('Nike', 'cberreclothb0@hugedomains.com', 'EnkÃƒÂ¶ping', 163939);
insert into SUPPLIER (company_name, email, location, company_id)
...
alter table ITEM enable constraint SYS_C009853;
prompt Enabling foreign key constraints for OWNS...
alter table OWNS enable constraint SYS_C009886;
alter table OWNS enable constraint SYS_C009887;
prompt Enabling foreign key constraints for STOREMAN...
alter table STOREMAN enable constraint SYS_C009864;
alter table STOREMAN enable constraint SYS_C009865;
prompt Enabling foreign key constraints for SUPPLIES...
alter table SUPPLIES enable constraint SYS_C009891;
alter table SUPPLIES enable constraint SYS_C009892;
prompt Enabling foreign key constraints for UNIFORM...
alter table UNIFORM enable constraint SYS_C009882;
prompt Enabling foreign key constraints for WEAPON...
alter table WEAPON enable constraint SYS_C009875;
...
prompt Enabling triggers for SOLDIERR...
alter table SOLDIERR enable all triggers;
